...
> Origem: ECC (MIT), adaptado para este projeto. Guia geral de .NET — partes web/backend
> podem não se aplicar a este plugin desktop AutoCAD.
...
- Note: `dotnet format` is **not** available in this repo (MSBuild-only build, `MSB4803`).
  Format in the IDE (Visual Studio) instead.
