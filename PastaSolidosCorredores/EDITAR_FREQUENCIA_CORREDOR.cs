...
namespace AutomacoesCivil3D
{
    ...
    {
        [CommandMethod("APPLY_REGION_FREQS_ALL", CommandFlags.Modal)]
        ...
        private static List<CorridorListItem> GetCorridorsList(Document civilDoc, CivilDocument civilDb)
        {
    ...
    public class FrequencySettingsForm : Form
    {
        ...
        private void CarregarCorredoresMarcados()
        {
